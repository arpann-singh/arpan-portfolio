    ...
    <div className="flex flex-col min-h-screen relative w-full overflow-hidden bg-slate-100 pb-32">
      ...
      <section className="relative z-10 flex flex-col justify-center min-h-screen px-6 sm:px-10 md:px-12 lg:px-16 container mx-auto pt-24 sm:pt-28 pb-6">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5 sm:gap-6 lg:gap-8 auto-rows-auto max-w-7xl mx-auto w-full">
          ...
          {/* MAIN WELCOME CARD WITH 3D TILT */}
          <TiltCard
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.6 }}
            className="col-span-1 md:col-span-2 lg:col-span-3 bg-white/60 backdrop-blur-3xl rounded-[2rem] p-8 sm:p-10 lg:p-12 shadow-[0_8px_30px_rgb(0,0,0,0.06)] border-2 border-white/80 flex flex-col justify-center relative group cursor-default"
          >
            ...
            <h1 ref={heroTextRef} className="font-syne text-4xl sm:text-5xl md:text-5xl lg:text-6xl font-extrabold tracking-tighter leading-none mb-4 relative z-10 text-slate-900 pointer-events-none">
              ...
              <div className="h-[1.2em] sm:h-[1.3em] flex items-center mt-1">
                <AnimatePresence mode="wait">
                  ...
                  >
                    ...
                    <span className="text-4xl sm:text-5xl md:text-5xl lg:text-6xl inline-block drop-shadow-sm pb-1.5">
          ...
          <TiltCard
            ...
            className="col-span-1 md:col-span-2 lg:col-span-1 lg:row-span-2 rounded-[2rem] shadow-[0_8px_30px_rgb(0,0,0,0.12)] border-4 border-white overflow-hidden relative min-h-[350px] sm:min-h-[450px] lg:min-h-full group"
          >
            <Image
              src="/hero-photo.jpg"
              alt="Arpan Singh"
          ...
          <motion.div
            ...
            className="col-span-1 md:col-span-1 relative min-h-[220px]"
          >
            <ApertureWidget />
          </motion.div>
          ...
          <TiltCard
            ...
            className="col-span-1 md:col-span-1 bg-white/60 backdrop-blur-3xl rounded-[2rem] p-6 sm:p-8 shadow-[0_8px_30px_rgb(0,0,0,0.06)] border-2 border-white/80 flex flex-col justify-between relative overflow-hidden group cursor-default"
          >
          ...
          <TiltCard
            ...
            className="col-span-1 md:col-span-2 lg:col-span-1 flex flex-col sm:flex-row lg:flex-col gap-5 lg:gap-6"
          >
            <Link
              href="/projects"
              className="flex-1 bg-gradient-to-br from-blue-600 to-indigo-600 rounded-[2rem] p-6 text-white flex flex-col justify-between group shadow-lg shadow-blue-500/20 border border-blue-400/30 transition-transform relative overflow-hidden min-h-[140px] sm:min-h-0"
            >
            ...
            <a
              href="/resume.pdf"
              download
              className="flex-1 sm:flex-none lg:flex-1 bg-white/80 backdrop-blur-3xl rounded-[2rem] p-5 border-2 border-white/80 text-slate-800 font-bold flex items-center justify-center gap-3 hover:bg-white transition-colors shadow-sm h-[72px] shrink-0 text-base"
            >
      ...
      <section className="relative z-20 py-8">
        <div className="container mx-auto px-6 sm:px-10 md:px-12 lg:px-16 max-w-7xl">
          ...
          >
            ...
            {/* We moved the grid wrapper HERE, inside the TiltCard */}
